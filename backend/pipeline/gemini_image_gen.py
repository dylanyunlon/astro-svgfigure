...
async def generate_image_with_gemini(
    ...
    **kwargs,  # sprite_images, skeleton_media_resolution, sprite_media_resolution
    ...
    combined_prompt = (
        ...
        f"6. ACADEMIC FIGURE STYLE — match real NeurIPS/CVPR/ICLR paper figures:\n"
        f"   ZERO TEXT BOXES: Do NOT draw any rounded-rectangle boxes with centered "
        f"text inside. In real academic figures, text labels appear as naked text "
        f"(no border, no fill) floating next to arrows or below illustrations. "
        ...
        f"at the corner, not in a separate box.\n"
        f"   WHITE SPACE BUDGET: Pure white pixels should be under 20% of the figure. "
        f"Blank horizontal bands should total under 12% of height. Blank vertical "
        f"bands should total under 18% of width.\n"
        f"   ASPECT RATIO: The figure should be roughly square (width:height ≈ 1:1), "
        f"not tall and narrow.\n"
