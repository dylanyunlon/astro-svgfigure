...
namespace
{
	TAutoConsoleVariable<bool> CVarMediaChromaInterpolation(
		TEXT("r.Media.ChromaInterpolation"),
		true,
		TEXT("Global kill-switch for chroma interpolation in 4:2:2 YUV media conversion shaders.\n")
		TEXT(" false: force off (nearest chroma)\n")
		TEXT(" true: allow callers to request interpolation (default)"),
		ECVF_RenderThreadSafe);

	// Callers opt in via SetParameters; the CVar can force-disable globally.
	uint32 ResolveChromaInterpolation(MediaShaders::EChromaInterpolation ChromaInterpolation)
	{
		const bool bEnabled = (ChromaInterpolation == MediaShaders::EChromaInterpolation::Enabled)
			&& CVarMediaChromaInterpolation.GetValueOnRenderThread();
...
void FNV12ConvertPS::SetParameters(FRHIBatchedShaderParameters& BatchedParameters, const FIntPoint & TexDim, FShaderResourceViewRHIRef SRV_Y, FShaderResourceViewRHIRef SRV_UV, const FIntPoint& OutputDimensions, const FMatrix44f& ColorTransform, UE::Color::EEncoding Encoding, const FMatrix44f& CSTransform, bool bSwapChroma, MediaShaders::EToneMapMethod ToneMapMethod)
{
	...
	static_assert(int32(UE::Color::EEncoding::Linear) == 1, "Enum mismatch with use in shader code!");
	static_assert(int32(UE::Color::EEncoding::sRGB) == 2, "Enum mismatch with use in shader code!");
	static_assert(int32(UE::Color::EEncoding::ST2084) == 3, "Enum mismatch with use in shader code!");
	static_assert(int32(UE::Color::EEncoding::Gamma22) == 4, "Enum mismatch with use in shader code!");
	static_assert(int32(UE::Color::EEncoding::BT1886) == 5, "Enum mismatch with use in shader code!");
	static_assert(int32(UE::Color::EEncoding::Gamma26) == 6, "Enum mismatch with use in shader code!");
	static_assert(int32(UE::Color::EEncoding::Cineon) == 7, "Enum mismatch with use in shader code!");
	static_assert(int32(UE::Color::EEncoding::REDLog) == 8, "Enum mismatch with use in shader code!");
	static_assert(int32(UE::Color::EEncoding::REDLog3G10) == 9, "Enum mismatch with use in shader code!");
	static_assert(int32(UE::Color::EEncoding::SLog1) == 10, "Enum mismatch with use in shader code!");
	static_assert(int32(UE::Color::EEncoding::SLog2) == 11, "Enum mismatch with use in shader code!");
	static_assert(int32(UE::Color::EEncoding::SLog3) == 12, "Enum mismatch with use in shader code!");
	static_assert(int32(UE::Color::EEncoding::AlexaV3LogC) == 13, "Enum mismatch with use in shader code!");
	static_assert(int32(UE::Color::EEncoding::CanonLog) == 14, "Enum mismatch with use in shader code!");
	static_assert(int32(UE::Color::EEncoding::ProTune) == 15, "Enum mismatch with use in shader code!");
	static_assert(int32(UE::Color::EEncoding::VLog) == 16, "Enum mismatch with use in shader code!");
	static_assert(int32(UE::Color::EEncoding::HLG) == 17, "Enum mismatch with use in shader code!");
...
SHADER_PARAMETER_SAMPLER(SamplerState, Sampler)
SHADER_PARAMETER(FMatrix44f, CSTransform)
SHADER_PARAMETER(uint32, EOTF)				// UE::Color::EEncoding value (see ColorManagementDefines.h).
SHADER_PARAMETER(uint32, ToneMapMethod)
END_GLOBAL_SHADER_PARAMETER_STRUCT()
...
/* FYUVScaledConvertPS shader
 *****************************************************************************/

BEGIN_GLOBAL_SHADER_PARAMETER_STRUCT(FYUVScaledConvertUB, )
SHADER_PARAMETER(FMatrix44f, ColorTransform)
SHADER_PARAMETER(uint32, SrgbToLinear)
SHADER_PARAMETER(FVector2f, UVScale)
SHADER_PARAMETER(float, YUVScale)
SHADER_PARAMETER_TEXTURE(Texture2D, YTexture)
SHADER_PARAMETER_TEXTURE(Texture2D, UTexture)
SHADER_PARAMETER_TEXTURE(Texture2D, VTexture)
SHADER_PARAMETER_SAMPLER(SamplerState, YSampler)
...
IMPLEMENT_GLOBAL_SHADER_PARAMETER_STRUCT(FYUVScaledConvertUB, "YUVScaledConvertUB");
IMPLEMENT_SHADER_TYPE(, FYUVScaledConvertPS, TEXT("/Engine/Private/MediaShaders.usf"), TEXT("YUVScaledConvertPS"), SF_Pixel);


void FYUVScaledConvertPS::SetParameters(FRHIBatchedShaderParameters& BatchedParameters, TRefCountPtr<FRHITexture> YTexture, TRefCountPtr<FRHITexture> UTexture, TRefCountPtr<FRHITexture> VTexture, const FIntPoint& OutputDimensions, const FMatrix& ColorTransform, const FVector& YUVOffset, bool SrgbToLinear, float YUVScale)
{
	FYUVScaledConvertUB UB;
	{
		UB.ColorTransform = (FMatrix44f)MediaShaders::CombineColorTransformAndOffset(ColorTransform, YUVOffset);
		UB.SrgbToLinear = SrgbToLinear;
		UB.YTexture = YTexture;
		...
		UB.VSampler = TStaticSamplerState<SF_Bilinear>::GetRHI();
		UB.UVScale = FVector2f((float) OutputDimensions.X / (float) YTexture->GetSizeX(), (float) OutputDimensions.Y / (float) YTexture->GetSizeY());
		UB.YUVScale = YUVScale;
	}

	TUniformBufferRef<FYUVScaledConvertUB> Data = TUniformBufferRef<FYUVScaledConvertUB>::CreateUniformBufferImmediate(UB, UniformBuffer_SingleFrame);
	SetUniformBufferParameter(BatchedParameters, GetUniformBufferParameter<FYUVScaledConvertUB>(), Data);
}


/* FYUVPlanesConvertPS shader
 *****************************************************************************/

BEGIN_GLOBAL_SHADER_PARAMETER_STRUCT(FYUVPlanesConvertUB, )
SHADER_PARAMETER(FMatrix44f, ColorTransform)
SHADER_PARAMETER(FMatrix44f, CSTransform)
SHADER_PARAMETER(uint32, EOTF)				// UE::Color::EEncoding value (see ColorManagementDefines.h). 128=HLG with OOTF.
SHADER_PARAMETER(uint32, ToneMapMethod)
SHADER_PARAMETER(FVector2f, UVScale)
SHADER_PARAMETER_TEXTURE(Texture2D, YTexture)
SHADER_PARAMETER_TEXTURE(Texture2D, UTexture)
...
IMPLEMENT_GLOBAL_SHADER_PARAMETER_STRUCT(FYUVPlanesConvertUB, "YUVPlanesConvertUB");
IMPLEMENT_SHADER_TYPE(, FYUVPlanesConvertPS, TEXT("/Engine/Private/MediaShaders.usf"), TEXT("YUVPlanesConvertPS"), SF_Pixel);


void FYUVPlanesConvertPS::SetParameters(FRHIBatchedShaderParameters& BatchedParameters, TRefCountPtr<FRHITexture> YTexture, TRefCountPtr<FRHITexture> UTexture, TRefCountPtr<FRHITexture> VTexture,
		...
		MediaShaders::EToneMapMethod ToneMapMethod)
{
	...
	TUniformBufferRef<FYUVPlanesConvertUB> Data = TUniformBufferRef<FYUVPlanesConvertUB>::CreateUniformBufferImmediate(UB, UniformBuffer_SingleFrame);
	SetUniformBufferParameter(BatchedParameters, GetUniformBufferParameter<FYUVPlanesConvertUB>(), Data);
}


/* FYUVAPlanesConvertPS shader
 *****************************************************************************/

BEGIN_GLOBAL_SHADER_PARAMETER_STRUCT(FYUVAPlanesConvertUB, )
SHADER_PARAMETER(FMatrix44f, ColorTransform)
SHADER_PARAMETER(FMatrix44f, CSTransform)
SHADER_PARAMETER(uint32, EOTF)
SHADER_PARAMETER(uint32, ToneMapMethod)
SHADER_PARAMETER(FVector2f, UVScale)
SHADER_PARAMETER(float, AScaleFactor)
SHADER_PARAMETER_TEXTURE(Texture2D, YTexture)
SHADER_PARAMETER_TEXTURE(Texture2D, UTexture)
SHADER_PARAMETER_TEXTURE(Texture2D, VTexture)
SHADER_PARAMETER_TEXTURE(Texture2D, ATexture)
SHADER_PARAMETER_SAMPLER(SamplerState, YSampler)
SHADER_PARAMETER_SAMPLER(SamplerState, USampler)
SHADER_PARAMETER_SAMPLER(SamplerState, VSampler)
SHADER_PARAMETER_SAMPLER(SamplerState, ASampler)
END_GLOBAL_SHADER_PARAMETER_STRUCT()

IMPLEMENT_GLOBAL_SHADER_PARAMETER_STRUCT(FYUVAPlanesConvertUB, "YUVAPlanesConvertUB");
IMPLEMENT_SHADER_TYPE(, FYUVAPlanesConvertPS, TEXT("/Engine/Private/MediaShaders.usf"), TEXT("YUVAPlanesConvertPS"), SF_Pixel);


void FYUVAPlanesConvertPS::SetParameters(FRHIBatchedShaderParameters& BatchedParameters, TRefCountPtr<FRHITexture> YTexture, TRefCountPtr<FRHITexture> UTexture, TRefCountPtr<FRHITexture> VTexture, TRefCountPtr<FRHITexture> ATexture, float AScaleFactor,
		const FIntPoint& OutputDimensions,
		const FMatrix44f& ColorTransform,
		UE::Color::EEncoding Encoding,
		const FMatrix44f& CSTransform,
		MediaShaders::EToneMapMethod ToneMapMethod)
{
	FYUVAPlanesConvertUB UB;
	{
		...
		UB.UTexture = UTexture;
		UB.VTexture = VTexture;
		UB.ATexture = ATexture;
		UB.YSampler = TStaticSamplerState<SF_Bilinear>::GetRHI();
		UB.USampler = TStaticSamplerState<SF_Bilinear>::GetRHI();
		UB.VSampler = TStaticSamplerState<SF_Bilinear>::GetRHI();
		UB.ASampler = TStaticSamplerState<SF_Bilinear>::GetRHI();
		UB.UVScale = FVector2f((float) OutputDimensions.X / (float) YTexture->GetSizeX(), (float) OutputDimensions.Y / (float) YTexture->GetSizeY());
		UB.AScaleFactor = AScaleFactor;
	}

	TUniformBufferRef<FYUVAPlanesConvertUB> Data = TUniformBufferRef<FYUVAPlanesConvertUB>::CreateUniformBufferImmediate(UB, UniformBuffer_SingleFrame);
	SetUniformBufferParameter(BatchedParameters, GetUniformBufferParameter<FYUVAPlanesConvertUB>(), Data);
}
...
SHADER_PARAMETER(uint32, ToneMapMethod)
SHADER_PARAMETER(uint32, IsCbY0CrY1)
SHADER_PARAMETER(uint32, InterpolateChroma)
SHADER_PARAMETER(float, OutputDimX)
SHADER_PARAMETER(float, OutputDimY)
SHADER_PARAMETER_TEXTURE(Texture2D<float4>, YUVTexture)
END_GLOBAL_SHADER_PARAMETER_STRUCT()
...
void FYUVv210ConvertPS::SetParameters(FRHIBatchedShaderParameters& BatchedParameters, TRefCountPtr<FRHITexture> YUVTexture, const FIntPoint& OutputDimensions, const FMatrix44f& ColorTransform, UE::Color::EEncoding Encoding, const FMatrix44f& CSTransform, bool bIsCbY0CrY1, MediaShaders::EToneMapMethod ToneMapMethod, MediaShaders::EChromaInterpolation ChromaInterpolation)
{
	FYUVv210ConvertUB UB;
	{
		...
		UB.ToneMapMethod = static_cast<uint32>(ToneMapMethod);
		UB.IsCbY0CrY1 = bIsCbY0CrY1;
		UB.InterpolateChroma = ResolveChromaInterpolation(ChromaInterpolation);
		UB.OutputDimX = (float)OutputDimensions.X;
		UB.OutputDimY = (float)OutputDimensions.Y;
		UB.YUVTexture = YUVTexture;
	}
...
SHADER_PARAMETER(uint32, EOTF)
SHADER_PARAMETER(uint32, ToneMapMethod)
SHADER_PARAMETER(FLinearColor, UVRotation)
SHADER_PARAMETER(FLinearColor, UVRotOffsetAndScale)
SHADER_PARAMETER_TEXTURE(Texture2D, Texture)
SHADER_PARAMETER_SAMPLER(SamplerState, Sampler)
END_GLOBAL_SHADER_PARAMETER_STRUCT()
...
void FVYUConvertPS::SetParameters(FRHIBatchedShaderParameters& BatchedParameters, TRefCountPtr<FRHITexture> VYUTexture, const FIntPoint& OutputDimensions, const FMatrix44f& ColorTransform, UE::Color::EEncoding Encoding, const FMatrix44f& CSTransform,
	MediaShaders::EToneMapMethod ToneMapMethod, const FLinearColor& UVRotation, const FLinearColor& UVRotOffset)
{
	FVYUConvertUB UB;
	{
		UB.ColorTransform = ColorTransform;
		...
		UB.EOTF = static_cast<uint32>(Encoding);
		UB.ToneMapMethod = static_cast<uint32>(ToneMapMethod);
		UB.UVRotation = UVRotation;
		UB.UVRotOffsetAndScale = FLinearColor(UVRotOffset.R, UVRotOffset.G, (float)OutputDimensions.X / (float)VYUTexture->GetSizeX(), (float)OutputDimensions.Y / (float)VYUTexture->GetSizeY());
...
/* FOutputProtectionSynthesisPS shader
 *****************************************************************************/

BEGIN_GLOBAL_SHADER_PARAMETER_STRUCT(FOutputProtectionSynthesisUB, )
SHADER_PARAMETER(FLinearColor, FillColor)
SHADER_PARAMETER(uint32, FillMode)
SHADER_PARAMETER(uint32, OutputWidth)
SHADER_PARAMETER(uint32, OutputHeight)
SHADER_PARAMETER(uint32, SrgbToLinear)
//SHADER_PARAMETER(FMatrix44f, ColorTransform)
...
IMPLEMENT_GLOBAL_SHADER_PARAMETER_STRUCT(FOutputProtectionSynthesisUB, "OutputProtectionSynthesisUB");
IMPLEMENT_SHADER_TYPE(, FOutputProtectionSynthesisPS, TEXT("/Engine/Private/MediaShaders.usf"), TEXT("OutputProtectionSynthesisPS"), SF_Pixel);


void FOutputProtectionSynthesisPS::SetParameters(FRHIBatchedShaderParameters& BatchedParameters, const FIntPoint& OutputDimensions, const FLinearColor& InColor, uint32 InFillMode, bool SrgbToLinear)
{
	FOutputProtectionSynthesisUB UB;
	{
		UB.FillColor = InColor;
		UB.FillMode = InFillMode;
		UB.OutputWidth = OutputDimensions.X;
		UB.OutputHeight = OutputDimensions.Y;
		UB.SrgbToLinear = SrgbToLinear;
	}

	TUniformBufferRef<FOutputProtectionSynthesisUB> Data = TUniformBufferRef<FOutputProtectionSynthesisUB>::CreateUniformBufferImmediate(UB, UniformBuffer_SingleFrame);
	SetUniformBufferParameter(BatchedParameters, GetUniformBufferParameter<FOutputProtectionSynthesisUB>(), Data);
}


/* FOutputProtectionMosaicPS shader
 *****************************************************************************/

BEGIN_GLOBAL_SHADER_PARAMETER_STRUCT(FOutputProtectionMosaicUB, )
SHADER_PARAMETER_TEXTURE(Texture2D, Texture)
SHADER_PARAMETER_SAMPLER(SamplerState, SamplerP)
...
IMPLEMENT_GLOBAL_SHADER_PARAMETER_STRUCT(FOutputProtectionMosaicUB, "OutputProtectionMosaicUB");
IMPLEMENT_SHADER_TYPE(, FOutputProtectionMosaicPS, TEXT("/Engine/Private/MediaShaders.usf"), TEXT("OutputProtectionMosaicPS"), SF_Pixel);


void FOutputProtectionMosaicPS::SetParameters(FRHIBatchedShaderParameters& BatchedParameters, TRefCountPtr<FRHITexture> SrcTexture, const FIntPoint& OutputDimensions, uint32 InBlockSize)
{
	FOutputProtectionMosaicUB UB;
	{
		UB.SamplerP = TStaticSamplerState<SF_Point>::GetRHI();
		UB.Texture = SrcTexture;
		UB.BlockSize = InBlockSize;
		UB.OutputWidth = OutputDimensions.X;
		UB.OutputHeight = OutputDimensions.Y;
	}

	TUniformBufferRef<FOutputProtectionMosaicUB> Data = TUniformBufferRef<FOutputProtectionMosaicUB>::CreateUniformBufferImmediate(UB, UniformBuffer_SingleFrame);
	SetUniformBufferParameter(BatchedParameters, GetUniformBufferParameter<FOutputProtectionMosaicUB>(), Data);
}
