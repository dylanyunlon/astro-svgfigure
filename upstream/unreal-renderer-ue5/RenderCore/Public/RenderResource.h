...
enum class ERayTracingMode : uint8
{
	Disabled,
	Enabled,
	Dynamic UE_DEPRECATED(5.9, "Ray Tracing on-demand is always supported so ERayTracingMode::Dynamic is effectively the same as ERayTracingMode::Enabled")
};
...
class TGlobalResource final : public ResourceType
{
public:
	/** Default constructor. */
	TGlobalResource()
