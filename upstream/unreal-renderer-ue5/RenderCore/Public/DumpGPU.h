...
{
public:
	RENDERCORE_API FDumpScope(bool bInCondition = true, const TCHAR* Cmd = TEXT(""), const TCHAR* Context = TEXT(""));
...
{
public:
	FDumpScope(bool bCondition = true, const TCHAR* Cmd = TEXT(""), const TCHAR* Context = TEXT("")) {}
};
