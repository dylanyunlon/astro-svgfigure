...
// Mobile-preview half-precision emulation on D3D PCD3D_ES3_1: enables PLATFORM_SUPPORTS_RELAXED_PRECISION so 'half' aliases to 'min16float'.
SHADER_COMPILER_FLAGS_ENTRY(UseHalfFloatPrecision)
