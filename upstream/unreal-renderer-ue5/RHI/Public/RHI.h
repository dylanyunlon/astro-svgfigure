...
RHI_API EGpuVendorId GetRHIDeviceVendorId();
...
UE_DEPRECATED(5.8, "RHIPreferredPixelFormatHint is deprecated. Viewports should be created or resized with an explicit pixel format, not with PF_Unknown.")
...
// helper to dump a summary of RHI resource usage to the log
RHI_API void RHIDumpResourceMemoryToLog(int32 NumberOfResourcesToShow);
...
// Get the bindless configuration specified via the command line
RHI_API TOptional<ERHIBindlessConfiguration> RHIGetForcedBindlessConfiguration();

UE_DEPRECATED(5.8, "RHIGetShaderPlatformConfigurationInt is no longer implemented.")
inline bool RHIGetShaderPlatformConfigurationInt(int32& OutSetting, FConfigCacheIni* Config, EShaderPlatform Platform, const TCHAR* SettingName)
{
	return false;
}

UE_DEPRECATED(5.8, "RHIGetShaderPlatformConfigurationInt is no longer implemented.")
inline bool RHIGetShaderPlatformConfigurationString(FString& OutSetting, FConfigCacheIni* Config, EShaderPlatform Platform, const TCHAR* SettingName)
{
	return false;
}

UE_DEPRECATED(5.8, "RHIParseBindlessConfiguration is no longer implemented. Please use FShaderPlatformConfig::GetBindlessConfiguration")
inline ERHIBindlessConfiguration RHIParseBindlessConfiguration(EShaderPlatform Platform, const FString& ConfigSetting, const FString& CvarSetting)
{
	return ERHIBindlessConfiguration::Disabled;
}

UE_DEPRECATED(5.8, "RHIGetRuntimeBindlessConfiguration is no longer implemented. Please use FShaderPlatformConfig::GetBindlessConfiguration")
inline ERHIBindlessConfiguration RHIGetRuntimeBindlessConfiguration(EShaderPlatform Platform)
{
	return ERHIBindlessConfiguration::Disabled;
}

UE_DEPRECATED(5.7, "RHIGetRuntimeBindlessResourcesConfiguration is no longer implemented. Please use FShaderPlatformConfig::GetBindlessConfiguration")
inline ERHIBindlessConfiguration RHIGetRuntimeBindlessResourcesConfiguration(EShaderPlatform Platform)
{
	return ERHIBindlessConfiguration::Disabled;
}

UE_DEPRECATED(5.7, "RHIGetRuntimeBindlessSamplersConfiguration is no longer implemented. Please use FShaderPlatformConfig::GetBindlessConfiguration")
inline ERHIBindlessConfiguration RHIGetRuntimeBindlessSamplersConfiguration(EShaderPlatform Platform)
{
	return ERHIBindlessConfiguration::Disabled;
}