...
public:
	...
	// Mobile UBO path: one entry per unique primitive
	TArray<FInstanceCullingContext::FUniquePrimitiveInfo, SceneRenderingAllocator> UniquePrimitives;
	...
	uint32 BatchedInstanceDataBufferElements = 0U;
	uint32 BatchedPrimitiveDataBufferElements = 0U;
	// Mobile UBO path: total unique primitives across batches
	uint32 TotalUniquePrimitives = 0U;
