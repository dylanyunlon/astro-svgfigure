...
DECLARE_LOG_CATEGORY_EXTERN(LogSkyAtmosphereRendering, Log, All)
...
bool ShouldSkySampleAtmosphereLightsOpaqueShadow(const FScene& Scene, const FVisibleLightInfoArray& VisibleLightInfos, SkyAtmosphereLightShadowData& LightShadowData, struct FDynamicShadowsTaskData* FilterDynamicShadowTaskData = nullptr);
