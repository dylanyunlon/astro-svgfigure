...
namespace Lumen
{
	...
	constexpr uint32 MaxMipSizeInPages = 1u << (MaxResLevel - SubAllocationResLevel);
	...
	bool IsSoftwareRayTracingSupported(EShaderPlatform ShaderPlatform);
	...
	bool IsHardwareRayTracedHitLightingSupported();
