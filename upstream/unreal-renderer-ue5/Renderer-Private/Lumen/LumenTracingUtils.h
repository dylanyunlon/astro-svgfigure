...
BEGIN_SHADER_PARAMETER_STRUCT(FLumenCardTracingParameters, )
	...
	SHADER_PARAMETER(uint32, SampleHeightFogOnGI)
	SHADER_PARAMETER(float, MinDistanceForFoggingSky)
	...
	SHADER_PARAMETER(uint32, GlobalDistanceFieldPageObjectGridBufferSize)
...
extern FLumenHZBScreenTraceParameters SetupHZBScreenTraceParameters(
	...
	EHZBType HZBType = EHZBType::ClosestHZB);
...
extern TAutoConsoleVariable<float> CVarLumenSkylightPrefilterMipBias;